...
def fout_image(sliprate,shearT,normalT,state_var,outputs,dep,plot_in_timestep,save_dir,Wf,vmin,vmax,plot_in_sec=False,save_on=True):
    ...
    for w in which:
        ...
        plot_image(X,Y,var,lab,save_dir,Wf,plot_in_timestep,vmin,vmax,plot_in_sec,save_on)
...
def plot_image(X,Y,var,lab,save_dir,Wf,plot_in_timestep,vmin,vmax,plot_in_sec,save_on):
